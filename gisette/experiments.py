...
class LC_model(nn.Module):
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.ReLU(),
            LocallyConnected1D(field_size=400, outputs_per_field=50, stride=400),
            nn.ReLU(),
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ReLU(),
            LocallyConnected1D(field_size=50, outputs_per_field=400, stride=50),
            nn.ReLU(),
            LocallyConnected1D(field_size=10, outputs_per_field=20, stride=10),
            nn.ReLU(),
...
class dense_model(nn.Module):
    def __init__(self):
        ...
        self.decoder = nn.Sequential(
            ...
            nn.ReLU(), 
            nn.Linear(in_features=64, out_features=1600)
        )
